 (function (window, HttpClient) {
         ...
         propertyDescriptors.response = {
             get: function () {
                 ...
                 if (responseType == 1) {
                     ...
                     // String or Stream response type - return streaming buffer
                     var response = "";
                     if (this._streamingBuffer !== undefined) {
     ...
     fuseXMLHttpRequest.prototype.open = function (
         ...
         // Initialize streaming buffer as instance variable
         ...
         self._fuseHttpRequest.ondone = function () {
             // Initialize streaming buffer if it doesn't exist
